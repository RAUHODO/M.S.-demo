...
const L = {
  cn: {
    ...
    headerSubtitle: '个人 AI 助手系统 · 本地数据库 · 《艾尔登法环》世界观包装 · 所有数据均为虚构演示',
    statusRunning: '运行中',
    uptime: '运行', backup: '备份',
    today: '今日', sevenD: '7日共',
  ...
  en: {
    ...
    headerSubtitle: 'Personal AI assistant OS · Local database · Elden Ring aesthetic · All data is fictional',
